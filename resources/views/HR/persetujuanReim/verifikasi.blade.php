                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <textarea type="file" class="form-control" id="deskripsi"></textarea>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <a href="{{url('/persetujuanReimHR')}}" class="btn btn-warning" style="width: 100%;">Batal</a>
                        </div>
                        <div class="col-md-9">
                            <a href="{{url('/persetujuanReimHR')}}" class="btn btn-success" style="width: 100%;">Simpan Data</a>
                        </div>
                    </div>
                  </div>
                </div>
