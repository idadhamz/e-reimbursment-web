                        ...
                        <table class="table table-striped table-bordered table-md my-3">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('persetujuanReimFinance/verifikasi') }}" class="btn btn-warning" style="border-radius: 0px;border-width: 1.5px;">Edit Verifikasi</a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <p>Verifikasi Finance <span style="color: gray;">Belum Verifikasi</span></p>
                                    </td>
                                    <td>
                                        <a href="{{ url('persetujuanReimFinance/verifikasi') }}" class="btn btn-success" style="border-radius: 0px;border-width: 1.5px;">Buat Verifikasi</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
